...
public class SableBridgeLogger {
    ...
    public static void init() {
        try {
            ...
            SableBridge.LOGGER.error("[SableAndroid] Failed to initialize SableBridge log directory: {}", new Object[]{var2.getMessage()});
        }
    }
    ...
    public static void logBridge(String var0) {
        ...
        SableBridge.LOGGER.info("[SableAndroid] {}", new Object[]{var0});
    ...
    public static void logBridgeWarn(String var0) {
        ...
        SableBridge.LOGGER.warn("[SableAndroid] {}", new Object[]{var0});
        if (bridgeWriter != null) {
            bridgeWriter.println(var1);
        }
    }
    ...
    public static void logBridgeError(String var0) {
        ...
        SableBridge.LOGGER.error("[SableAndroid] {}", new Object[]{var0});
        if (bridgeWriter != null) {
            bridgeWriter.println(var1);
        }
    }
    ...
    public static void logSable(String var0) {
        ...
        SableBridge.LOGGER.info("[Sable] {}", new Object[]{var0});
        if (sableWriter != null) {
    ...
    public static void logSableWarn(String var0) {
        ...
        SableBridge.LOGGER.warn("[Sable] {}", new Object[]{var0});
        if (sableWriter != null) {
            sableWriter.println(var1);
        }
    }
    ...
    public static void logRender(String var0) {
        ...
        SableBridge.LOGGER.info("[Render] {}", new Object[]{var0});
    ...
    public static void logRenderWarn(String var0) {
        ...
        SableBridge.LOGGER.warn("[Render] {}", new Object[]{var0});
        if (renderWriter != null) {
            renderWriter.println(var1);
        }
    }
